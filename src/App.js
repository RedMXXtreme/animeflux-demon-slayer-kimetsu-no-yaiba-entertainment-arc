...
const AnimePage = () => {
  const videos = [
    ...
    { id: 5, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=5", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 6, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=6", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 7, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=7", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 8, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=8", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 9, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=9", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 10, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=10", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
    { id: 11, src: "https://yasdownloads.org/demon-slayer-entertainment-district-arc-17483?season=01&episode=11", HD1: "", HD2: "", HDSUB1: "", HDSUB2: "" },
  ];
  ...
  const ranvideo = [
    ...
    { link: "/https://animeflux-god-of-high-school.pages.dev", },
    { link: "https://animeflux-solo-leveling-s01.pages.dev", },
  ...
  useEffect(() => {
    ...
    setCurrentVideo(defaultVideo.MULTI); // Using MULTI as default
  ...
  const handleEpisodetoggle = (id) => {
    ...
    let nextVideo = selectedVideo[selectedserver];
    if (!nextVideo) nextVideo = selectedVideo.MULTI;
